...
import com.example.nmadrawingapp.view.adapters.EventAdapter;
...
public class UploadFragment extends Fragment {
    ...
    public static final int GAP = 30; // gap size between items in recycler view
...
//        RecyclerView.LayoutManager layoutManager = new GridLayoutManager(requireContext(), COLUMN_COUNT);
        ...
        uploadViewModel.getAllEvents().observe(getViewLifecycleOwner(), images -> {
            adapter.setEvents(images);
        });
